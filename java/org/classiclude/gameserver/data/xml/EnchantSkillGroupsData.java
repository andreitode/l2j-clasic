...
public class EnchantSkillGroupsData implements IXmlReader
{
	...
	public void parseDocument(Document doc, File f)
	{
		forEach(doc, "list", listNode -> forEach(listNode, "enchant", enchantNode ->
		{
			...
			forEach(enchantNode, "levelChances", levelChancesNode -> forEach(levelChancesNode, "levelChance", levelChanceNode -> enchantSkillHolder.addLevelChance(parseEnum(levelChanceNode.getAttributes(), SkillEnchantType.class, "type"), parseInteger(levelChanceNode.getAttributes(), "level"), parseInteger(levelChanceNode.getAttributes(), "value"))));
			...
			forEach(enchantNode, "exp", expNode -> enchantSkillHolder.addRequiredExp(parseEnum(expNode.getAttributes(), SkillEnchantType.class, "type"), parseLong(expNode.getAttributes(), "amount")));
