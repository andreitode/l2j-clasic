...
import org.classiclude.gameserver.network.serverpackets.ServerClose;
...
public class Shutdown extends Thread
{
	...
	private void startShutdownActions()
	{
		...
		try
		{
			// Detener VipExpirationTaskManager
			VipExpirationTaskManager.shutdown();
			LOGGER.info("VipExpirationTaskManager: Tareas detenidas (" + tc.getEstimatedTimeAndRestartCounter() + "ms).");
		}
		catch (Throwable t)
		{
			LOGGER.log(Level.WARNING, "Error al detener VipExpirationTaskManager.", t);
		}
