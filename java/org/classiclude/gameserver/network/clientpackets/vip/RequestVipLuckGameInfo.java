 ...
 */
/*
 * package org.classiclude.gameserver.network.clientpackets.vip; import org.classiclude.gameserver.model.actor.Player; import org.classiclude.gameserver.network.clientpackets.ClientPacket; import org.classiclude.gameserver.network.serverpackets.vip.ReceiveVipLuckyGameInfo; public class
 * RequestVipLuckGameInfo extends ClientPacket {
 * @Override protected void readImpl() { }
 * @Override protected void runImpl() { final Player player = getPlayer(); if (player == null) { return; } player.sendPacket(new ReceiveVipLuckyGameInfo(player)); } }
 */