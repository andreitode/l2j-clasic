							...
							switch (winningCabal)
							{
								...
								case SevenSigns.CABAL_DAWN:
								{
									if (dawnPercent >= 35)
									{
										...
										buffer.writeInt(SystemMessageId.ALTHOUGH_THE_SEAL_WAS_NOT_OWNED_35_OR_MORE_PEOPLE_HAVE_VOTED.getId());
									}
									else
									{
										buffer.writeByte(SevenSigns.CABAL_NULL);
										buffer.writeInt(SystemMessageId.ALTHOUGH_THE_SEAL_WAS_NOT_OWNED_35_OR_LESS_PEOPLE_HAVE_VOTED.getId());
									}
									break;
								}
						...
						case SevenSigns.CABAL_DAWN:
						{
							switch (winningCabal)
							{
								case SevenSigns.CABAL_NULL:
								{
									...
									{
										buffer.writeByte(SevenSigns.CABAL_DAWN);
										buffer.writeInt(SystemMessageId.THE_SEAL_WAS_OWNED_DURING_THE_PREVIOUS_PERIOD_AND_10_OR_MORE_PEOPLE_HAVE_VOTED.getId());
									}
									else
									{
										buffer.writeByte(SevenSigns.CABAL_NULL);
