...
import org.classiclude.gameserver.ai.CreatureAI.IntentionCommand;
import org.classiclude.gameserver.ai.CtrlIntention;
import org.classiclude.gameserver.ai.PlayerAI;
import org.classiclude.gameserver.ai.SummonAI;
import org.classiclude.gameserver.cache.RelationCache;
import org.classiclude.gameserver.communitybbs.BB.Forum;
...
import org.classiclude.gameserver.enums.AdminTeleportType;
import org.classiclude.gameserver.enums.BroochJewel;
...
import org.classiclude.gameserver.enums.GroupType;
import org.classiclude.gameserver.enums.HtmlActionScope;
...
import org.classiclude.gameserver.enums.MountType;
import org.classiclude.gameserver.enums.NextActionType;
import org.classiclude.gameserver.enums.PartyDistributionType;
import org.classiclude.gameserver.enums.PartyMessageType;
import org.classiclude.gameserver.enums.PartySmallWindowUpdateType;
import org.classiclude.gameserver.enums.PlayerAction;
import org.classiclude.gameserver.enums.PlayerCondOverride;
import org.classiclude.gameserver.enums.PrivateStoreType;
import org.classiclude.gameserver.enums.Race;
import org.classiclude.gameserver.enums.Sex;
import org.classiclude.gameserver.enums.ShortcutType;
import org.classiclude.gameserver.enums.SkillFinishType;
import org.classiclude.gameserver.enums.StatusUpdateType;
import org.classiclude.gameserver.enums.SubclassInfoType;
import org.classiclude.gameserver.enums.Team;
...
import org.classiclude.gameserver.handler.ItemHandler;
...
import org.classiclude.gameserver.instancemanager.DuelManager;
...
import org.classiclude.gameserver.instancemanager.RecipeManager;
...
import org.classiclude.gameserver.model.AccessLevel;
import org.classiclude.gameserver.model.BlockList;
import org.classiclude.gameserver.model.CommandChannel;
import org.classiclude.gameserver.model.ContactList;
import org.classiclude.gameserver.model.Duel;
import org.classiclude.gameserver.model.Location;
import org.classiclude.gameserver.model.Macro;
import org.classiclude.gameserver.model.MacroList;
import org.classiclude.gameserver.model.ManufactureItem;
import org.classiclude.gameserver.model.Party;
import org.classiclude.gameserver.model.PetData;
import org.classiclude.gameserver.model.PetLevelData;
import org.classiclude.gameserver.model.PremiumItem;
import org.classiclude.gameserver.model.Radar;
import org.classiclude.gameserver.model.RecipeList;
import org.classiclude.gameserver.model.Request;
import org.classiclude.gameserver.model.ShortCuts;
import org.classiclude.gameserver.model.Shortcut;
...
import org.classiclude.gameserver.model.TradeList;
...
import org.classiclude.gameserver.model.actor.instance.Boat;
import org.classiclude.gameserver.model.actor.instance.ControlTower;
import org.classiclude.gameserver.model.actor.instance.Defender;
import org.classiclude.gameserver.model.actor.instance.Doppelganger;
import org.classiclude.gameserver.model.actor.instance.FriendlyMob;
import org.classiclude.gameserver.model.actor.instance.Guard;
import org.classiclude.gameserver.model.actor.instance.Pet;
import org.classiclude.gameserver.model.actor.instance.Shuttle;
import org.classiclude.gameserver.model.actor.instance.TamedBeast;
import org.classiclude.gameserver.model.actor.instance.Trap;
import org.classiclude.gameserver.model.actor.request.AbstractRequest;
import org.classiclude.gameserver.model.actor.request.SayuneRequest;
import org.classiclude.gameserver.model.actor.stat.PlayerStat;
import org.classiclude.gameserver.model.actor.status.PlayerStatus;
import org.classiclude.gameserver.model.actor.tasks.player.DismountTask;
import org.classiclude.gameserver.model.actor.tasks.player.FameTask;
import org.classiclude.gameserver.model.actor.tasks.player.HennaDurationTask;
import org.classiclude.gameserver.model.actor.tasks.player.InventoryEnableTask;
import org.classiclude.gameserver.model.actor.tasks.player.LookingForFishTask;
import org.classiclude.gameserver.model.actor.tasks.player.PetFeedTask;
import org.classiclude.gameserver.model.actor.tasks.player.RecoGiveTask;
import org.classiclude.gameserver.model.actor.tasks.player.RentPetTask;
import org.classiclude.gameserver.model.actor.tasks.player.ResetChargesTask;
import org.classiclude.gameserver.model.actor.tasks.player.ResetSoulsTask;
import org.classiclude.gameserver.model.actor.tasks.player.SitDownTask;
import org.classiclude.gameserver.model.actor.tasks.player.StandUpTask;
import org.classiclude.gameserver.model.actor.tasks.player.TeleportWatchdogTask;
import org.classiclude.gameserver.model.actor.tasks.player.WarnUserTakeBreakTask;
import org.classiclude.gameserver.model.actor.tasks.player.WaterTask;
import org.classiclude.gameserver.model.actor.templates.PlayerTemplate;
import org.classiclude.gameserver.model.actor.transform.Transform;
...
import org.classiclude.gameserver.model.cubic.Cubic;
...
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayableExpChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerAbilityPointsChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerFameChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerHennaAdd;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerHennaRemove;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerItemEquip;
...
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerLogout;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerMenteeStatus;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerMentorStatus;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerPKChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerProfessionCancel;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerProfessionChange;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerPvPChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerPvPKill;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerReputationChanged;
import org.classiclude.gameserver.model.events.impl.creature.player.OnPlayerSubChange;
import org.classiclude.gameserver.model.events.listeners.FunctionEventListener;
import org.classiclude.gameserver.model.events.returns.TerminateReturn;
import org.classiclude.gameserver.model.events.timers.TimerHolder;
import org.classiclude.gameserver.model.fishing.Fish;
...
import org.classiclude.gameserver.model.holders.AutoPlaySettingsHolder;
import org.classiclude.gameserver.model.holders.AutoUseSettingsHolder;
import org.classiclude.gameserver.model.holders.ItemHolder;
import org.classiclude.gameserver.model.holders.MovieHolder;
import org.classiclude.gameserver.model.holders.PreparedMultisellListHolder;
import org.classiclude.gameserver.model.holders.SellBuffHolder;
import org.classiclude.gameserver.model.holders.SkillHolder;
import org.classiclude.gameserver.model.holders.SkillUseHolder;
import org.classiclude.gameserver.model.holders.SubClassHolder;
import org.classiclude.gameserver.model.holders.TrainingHolder;
...
import org.classiclude.gameserver.model.item.Armor;
import org.classiclude.gameserver.model.item.EtcItem;
import org.classiclude.gameserver.model.item.Henna;
...
import org.classiclude.gameserver.model.itemcontainer.ItemContainer;
import org.classiclude.gameserver.model.itemcontainer.PetInventory;
import org.classiclude.gameserver.model.itemcontainer.PlayerFreight;
import org.classiclude.gameserver.model.itemcontainer.PlayerInventory;
import org.classiclude.gameserver.model.itemcontainer.PlayerRefund;
import org.classiclude.gameserver.model.itemcontainer.PlayerWarehouse;
import org.classiclude.gameserver.model.matching.MatchingRoom;
import org.classiclude.gameserver.model.olympiad.Hero;
import org.classiclude.gameserver.model.olympiad.OlympiadGameManager;
import org.classiclude.gameserver.model.olympiad.OlympiadGameTask;
...
import org.classiclude.gameserver.model.quest.QuestTimer;
...
import org.classiclude.gameserver.model.skill.AbnormalType;
...
import org.classiclude.gameserver.model.skill.SkillCastingType;
...
import org.classiclude.gameserver.model.stats.BaseStat;
import org.classiclude.gameserver.model.stats.Formulas;
import org.classiclude.gameserver.model.stats.MoveType;
...
import org.classiclude.gameserver.model.zone.ZoneRegion;
import org.classiclude.gameserver.model.zone.ZoneType;
import org.classiclude.gameserver.model.zone.type.BossZone;
import org.classiclude.gameserver.model.zone.type.WaterZone;
...
import org.classiclude.gameserver.network.serverpackets.AbstractHtmlPacket;
...
import org.classiclude.gameserver.network.serverpackets.ChangeWaitType;
...
import org.classiclude.gameserver.network.serverpackets.ExAbnormalStatusUpdateFromTarget;
...
import org.classiclude.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import org.classiclude.gameserver.network.serverpackets.ExFishingEnd;
import org.classiclude.gameserver.network.serverpackets.ExFishingStart;
import org.classiclude.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import org.classiclude.gameserver.network.serverpackets.ExGetOnAirShip;
import org.classiclude.gameserver.network.serverpackets.ExMagicAttackInfo;
import org.classiclude.gameserver.network.serverpackets.ExOlympiadMode;
import org.classiclude.gameserver.network.serverpackets.ExPledgeCount;
import org.classiclude.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import org.classiclude.gameserver.network.serverpackets.ExQuestItemList;
import org.classiclude.gameserver.network.serverpackets.ExSendUIEventCustom;
import org.classiclude.gameserver.network.serverpackets.ExSetCompassZoneCode;
import org.classiclude.gameserver.network.serverpackets.ExStartScenePlayer;
import org.classiclude.gameserver.network.serverpackets.ExStopScenePlayer;
import org.classiclude.gameserver.network.serverpackets.ExStorageMaxCount;
import org.classiclude.gameserver.network.serverpackets.ExSubjobInfo;
import org.classiclude.gameserver.network.serverpackets.ExUseSharedGroupItem;
...
import org.classiclude.gameserver.network.serverpackets.GetOnVehicle;
...
import org.classiclude.gameserver.network.serverpackets.MyTargetSelected;
import org.classiclude.gameserver.network.serverpackets.NicknameChanged;
import org.classiclude.gameserver.network.serverpackets.ObservationMode;
import org.classiclude.gameserver.network.serverpackets.ObservationReturn;
import org.classiclude.gameserver.network.serverpackets.PartySmallWindowUpdate;
import org.classiclude.gameserver.network.serverpackets.PetInventoryUpdate;
import org.classiclude.gameserver.network.serverpackets.PlaySound;
...
import org.classiclude.gameserver.network.serverpackets.PrivateStoreListBuy;
import org.classiclude.gameserver.network.serverpackets.PrivateStoreListSell;
import org.classiclude.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import org.classiclude.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import org.classiclude.gameserver.network.serverpackets.PrivateStoreMsgSell;
import org.classiclude.gameserver.network.serverpackets.RecipeShopMsg;
import org.classiclude.gameserver.network.serverpackets.RecipeShopSellList;
import org.classiclude.gameserver.network.serverpackets.RelationChanged;
import org.classiclude.gameserver.network.serverpackets.Ride;
import org.classiclude.gameserver.network.serverpackets.ServerPacket;
import org.classiclude.gameserver.network.serverpackets.SetupGauge;
...
import org.classiclude.gameserver.network.serverpackets.Snoop;
import org.classiclude.gameserver.network.serverpackets.SocialAction;
import org.classiclude.gameserver.network.serverpackets.StatusUpdate;
import org.classiclude.gameserver.network.serverpackets.StopMove;
import org.classiclude.gameserver.network.serverpackets.SystemMessage;
import org.classiclude.gameserver.network.serverpackets.TargetSelected;
import org.classiclude.gameserver.network.serverpackets.TargetUnselected;
import org.classiclude.gameserver.network.serverpackets.TradeDone;
import org.classiclude.gameserver.network.serverpackets.TradeOtherDone;
import org.classiclude.gameserver.network.serverpackets.TradeStart;
...
import org.classiclude.gameserver.network.serverpackets.commission.ExResponseCommissionInfo;
import org.classiclude.gameserver.network.serverpackets.friend.FriendStatus;
...
import org.classiclude.gameserver.taskmanager.AutoPlayTaskManager;
import org.classiclude.gameserver.taskmanager.AutoUseTaskManager;
...
import org.classiclude.gameserver.taskmanager.PlayerAutoSaveTaskManager;
import org.classiclude.gameserver.taskmanager.PvpFlagTaskManager;
...
public class Player extends Playable
{
	...
	private String _lastCBPageBypass;
	...
	public void sitDown(boolean checkCast)
	{
		...
		if (!_waitTypeSitting && !isAttackDisabled() && !isControlBlocked() && !isImmobilized() && !_fishing)
		{
			breakAttack();
			setSitting(true);
	...
	public void restoreExp(double restorePercent)
	{
		if (_expBeforeDeath > 0)
		{
			...
			getStat().addExpNoKarma(Math.round(((_expBeforeDeath - getExp()) * restorePercent) / 100));
			setExpBeforeDeath(0);
		}
	}
	...
	private boolean createDb()
	{
			...
			PreparedStatement statement = con.prepareStatement(INSERT_CHARACTER))
		{
			...
			statement.setLong(34, _newbie ? 1 : 0);
	 ...
	 * Calculate Henna modifiers of this Player.
	 */
	private static final int MAX_STAT_INCREASE = 5;
	
	private void recalcHennaStats(boolean recalculatePlayerStat)
	{
		_hennaBaseStats.clear();
		
		Map<BaseStat, Integer> temporaryStats = new EnumMap<>(BaseStat.class);
		...
		for (Henna henna : _henna)
		{
			...
			{
				temporaryStats.merge(entry.getKey(), entry.getValue(), Integer::sum);
			}
		}
		
		for (Entry<BaseStat, Integer> entry : temporaryStats.entrySet())
		{
			BaseStat stat = entry.getKey();
			int totalValue = entry.getValue();
			
			if (totalValue > MAX_STAT_INCREASE)
			{
				totalValue = MAX_STAT_INCREASE;
			}
			
			_hennaBaseStats.put(stat, totalValue);
		}
	...
	public boolean useMagic(Skill skill, Item item, boolean forceUse, boolean dontMove)
	{
		...
		if (_fishing && !usedSkill.hasEffectType(EffectType.FISHING, EffectType.FISHING_START))
		{
	...
	public void disableAutoBlessedShots()
	{
		Set<Integer> blessedShotIds = Set.of(3947, 3948, 3949, 3950, 3951, 3952);
		
		for (int itemId : getAutoSoulShot())
		{
			if (blessedShotIds.contains(itemId))
			{
	...
	public void doRevive()
	{
		...
		getEffectList().updateEffectList(true);
	}
	 ...
	 * @return
	 */
	public String getLastCBPageBypass()
	{
		return this._lastCBPageBypass;
	}
	
	/**
	 * @param command
	 */
	public void setLastCBPageBypass(String command)
	{
		this._lastCBPageBypass = command;
	}
	...
	// BLOQUE DE CODIGO PARA DEJAR DE VER APARIENCIAS
	
	private boolean hideAppearance = false; // Por defecto, las Apparences son visibles.
	
	public boolean isHideAppearanceEnabled()
	{
		return hideAppearance;
	}
	
	public void setHideAppearance(boolean hideAppearance)
	{
		this.hideAppearance = hideAppearance;
	}
	
	// BLOQUE DE IMPLEMENTACION DE PESCA INTERLUDE
	private Fish _fish;
	...
	public void startFishing(int x, int y, int z)
	{
		...
		sendPacket(new ExSendUIEventCustom(ExSendUIEventCustom.OPEN_FISH_WND, 0, 0, "", "", "", "", "", ""));
	...
	public void endFishing(boolean win)
	{
		...
		sendPacket(new ExSendUIEventCustom(ExSendUIEventCustom.CLOSE_FISH_WND, 0, 0, "", "", "", "", "", ""));
	...
	{
		return (getSiegeState() > 0) && isInsideZone(ZoneId.SIEGE) && (getSiegeState() == ((Player) target).getSiegeState()) && (getSiegeSide() == ((Player) target).getSiegeSide());
	}
	
	// BLOQUE DE CODIGO DE SKILLS DE USO DE SEED ELEMENTAL
