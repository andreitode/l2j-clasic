...
public class LookingForFishTask implements Runnable
{
	...
	private static final Logger LOGGER = Logger.getLogger(LookingForFishTask.class.getName());
	...
	public void run()
	{
		try
		{
			...
			{
				LOGGER.warning("Player reference in LookingForFishTask is null.");
			}
		}
		catch (Exception e)
		{
			LOGGER.severe("Exception in LookingForFishTask: " + e.getMessage());
