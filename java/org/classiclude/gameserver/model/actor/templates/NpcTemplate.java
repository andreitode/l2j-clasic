 ...
 */
package org.classiclude.gameserver.model.actor.templates;
...
import org.classiclude.gameserver.enums.MpRewardType;
...
import org.classiclude.gameserver.model.holders.DropGroupHolder;
...
public class NpcTemplate extends CreatureTemplate implements IIdentifiable
{
	...
	private void processVipDrops(List<ItemHolder> items, Creature victim, Creature killer)
	{
		...
		if (killer.asPlayer() != null)
		{
			float silverCoinChance = VipManager.getInstance().getSilverCoinDropChance(killer.asPlayer());
			float rustyCoinChance = VipManager.getInstance().getRustyCoinDropChance(killer.asPlayer());
