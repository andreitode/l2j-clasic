...
import org.classiclude.gameserver.model.skill.SkillBuffType;
import org.classiclude.gameserver.network.serverpackets.AbnormalStatusUpdate;
import org.classiclude.gameserver.network.serverpackets.ExAbnormalStatusUpdateFromTarget;
import org.classiclude.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import org.classiclude.gameserver.network.serverpackets.PartySpelled;
import org.classiclude.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
public class EffectList
{
		...
		for (SkillBuffType buffType : buffTypes)
		{
			switch (buffType)
			{
				...
				case DANCE:
				{
					...
					if ((getBuffCount() + _danceCount.get()) >= _owner.getStat().getMaxBuffCount())
					{
						return true;
					}
					break;
	 ...
	 */
	public void updateEffectList(boolean broadcast)
	{
