...
public class Q00242_PossessorOfAPreciousSoul2 extends Quest
{
	...
	public Q00242_PossessorOfAPreciousSoul2()
	{
		...
		setQuestNameNpcStringId(NpcStringId.PATH_OF_THE_NOBLESSE_PRECIOUS_SOUL_2);
	}
...
//				final Npc pure = addSpawn(PURE_UNICORN, 85884, -76588, -3470, 30000);
				// considering that this is the correct method
				final Npc pure = addSpawn(PURE_UNICORN, 85884, -76588, -3470, 0, false, 30000, false);
...
//				final Npc fallen = addSpawn(FALLEN_UNICORN, 85884, -76588, -3470, 0);
				// considering that this is the correct method
				final Npc fallen = addSpawn(FALLEN_UNICORN, 85884, -76588, -3470, 0, false,0, true);
