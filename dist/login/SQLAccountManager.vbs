...
'Run the installer.
shell.Run "cmd /c start ""ClassicLude - SQL Account Manager"" " & path & "java -Djava.util.logging.config.file=console.cfg -cp ./../libs/* org.classiclude.tools.accountmanager.SQLAccountManager", 1, False
