...
import org.classiclude.gameserver.enums.ClanHallGrade;
...
import org.classiclude.gameserver.model.residences.ResidenceFunction;
import org.classiclude.gameserver.model.residences.ResidenceFunctionTemplate;
import org.classiclude.gameserver.model.residences.ResidenceFunctionType;
import org.classiclude.gameserver.model.teleporter.TeleportHolder;
import org.classiclude.gameserver.network.NpcStringId;
import org.classiclude.gameserver.network.serverpackets.AgitDecoInfo;
					...
					if (player.hasClanPrivilege(ClanPrivilege.CH_SET_FUNCTIONS))
					{
						...
						else
						{
							switch (st.nextToken())
							{
								case "recovery":
								{
									if (clanHall.getGrade() == ClanHallGrade.GRADE_S)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncRecoverySGrade.html");
									}
									else if (clanHall.getGrade() == ClanHallGrade.GRADE_B)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncRecoveryBGrade.html");
									}
									else if (clanHall.getGrade() == ClanHallGrade.GRADE_C)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncRecoveryCGrade.html");
									}
								...
								case "other":
								{
									if (clanHall.getGrade() == ClanHallGrade.GRADE_S)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncOtherSGrade.html");
									}
									else if (clanHall.getGrade() == ClanHallGrade.GRADE_B)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncOtherBGrade.html");
									}
									else if (clanHall.getGrade() == ClanHallGrade.GRADE_C)
									{
										htmltext = getHtm(player, "ClanHallManager-manageFuncOtherCGrade.html");
									}
