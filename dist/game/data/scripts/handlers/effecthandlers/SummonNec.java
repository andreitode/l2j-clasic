...
public class SummonNec extends AbstractEffect
{
	...
	public SummonNec(StatSet params)
	{
		if (params.isEmpty())
		{
	...
	public void onstar(Creature effector, Creature effected, Skill skill, Item item)
	{
		if (!effected.isPlayer() || effector.hasSummon())
		{
			return;
		}
	}
