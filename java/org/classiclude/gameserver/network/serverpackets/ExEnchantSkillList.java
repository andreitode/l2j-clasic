	...
	private String getSkillEnchantListHtml(Player player)
	{
		...
		else
		{
			...
			for (int i = startIndex; i < endIndex; i++)
			{
				...
				sb.append("<a action=\"bypass -h _bbsskillenchantspecific npc_").append(player.getTargetId()).append("_showSkillDetails ").append(entry.getSkillId()).append(" ").append(entry.getRouteId()).append("\">"); // Incluir routeId en el bypass
