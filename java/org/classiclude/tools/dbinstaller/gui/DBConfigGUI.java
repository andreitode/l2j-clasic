package org.classiclude.tools.dbinstaller.gui;
...
import org.classiclude.commons.ui.SplashScreen;
import org.classiclude.tools.dbinstaller.RunTasks;
import org.classiclude.tools.dbinstaller.util.mysql.MySqlConnect;
import org.classiclude.tools.dbinstaller.util.swing.SpringUtilities;
...
public class DBConfigGUI extends JFrame
{
	...
	{
		super("ClassicLude - DB Installer");
		setVisible(false);
		...
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "classiclude_16x16.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "classiclude_32x32.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "classiclude_64x64.png").getImage());
		icons.add(new ImageIcon(".." + File.separator + "images" + File.separator + "classiclude_128x128.png").getImage());
		setIconImages(icons);
