...
import org.classiclude.gameserver.enums.AttributeType;
import org.classiclude.gameserver.enums.Movie;
...
import org.classiclude.gameserver.model.events.annotations.Id;
import org.classiclude.gameserver.model.events.annotations.Ids;
import org.classiclude.gameserver.model.events.annotations.NpcLevelRange;
import org.classiclude.gameserver.model.events.annotations.NpcLevelRanges;
import org.classiclude.gameserver.model.events.annotations.Priority;
import org.classiclude.gameserver.model.events.annotations.Range;
import org.classiclude.gameserver.model.events.annotations.Ranges;
import org.classiclude.gameserver.model.events.annotations.RegisterEvent;
import org.classiclude.gameserver.model.events.annotations.RegisterType;
...
import org.classiclude.gameserver.model.events.listeners.AbstractEventListener;
import org.classiclude.gameserver.model.events.listeners.AnnotationEventListener;
import org.classiclude.gameserver.model.events.listeners.ConsumerEventListener;
import org.classiclude.gameserver.model.events.listeners.DummyEventListener;
import org.classiclude.gameserver.model.events.listeners.FunctionEventListener;
import org.classiclude.gameserver.model.events.listeners.RunnableEventListener;
import org.classiclude.gameserver.model.events.returns.AbstractEventReturn;
import org.classiclude.gameserver.model.events.returns.TerminateReturn;
import org.classiclude.gameserver.model.events.timers.IEventTimerCancel;
import org.classiclude.gameserver.model.events.timers.IEventTimerEvent;
...
import org.classiclude.gameserver.model.instancezone.InstanceTemplate;
import org.classiclude.gameserver.model.interfaces.IPositionable;
import org.classiclude.gameserver.model.item.EtcItem;
import org.classiclude.gameserver.model.item.ItemTemplate;
import org.classiclude.gameserver.model.item.enchant.attribute.AttributeHolder;
...
import org.classiclude.gameserver.model.itemcontainer.Mail;
...
import org.classiclude.gameserver.network.serverpackets.SpecialCamera;
import org.classiclude.gameserver.network.serverpackets.SystemMessage;
import org.classiclude.gameserver.scripting.ManagedScript;
import org.classiclude.gameserver.taskmanager.GameTimeTaskManager;
import org.classiclude.gameserver.util.MinionList;
...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	...
	/**
	 * Provides instant callback operation when {@link org.classiclude.gameserver.model.actor.Creature} Enters on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.classiclude.gameserver.model.actor.Creature} Exits on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.classiclude.gameserver.model.actor.instance.Trap} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * @param count
	 */
	public static void giveItemse(Player player, int itemId, long count)
	{
		giveItemse(player, itemId, count, 0, false);
	}
	 ...
	 * @param playSound
	 */
	public static void giveItemse(Player player, int itemId, long count, boolean playSound)
	{
		giveItemse(player, itemId, count, 0, playSound);
	}
	 ...
	 * @param holder
	 */
	protected void giveItemse(Player player, ItemHolder holder)
	{
		giveItemse(player, holder.getId(), holder.getCount());
	}
	 ...
	 * @param playSound
	 */
	public static void giveItemse(Player player, int itemId, long count, int enchantlevel, boolean playSound)
	{
	 ...
	 * @param attributeValue
	 */
	public static void giveItemse(Player player, int itemId, long count, AttributeType attributeType, int attributeValue)
	{
	 ...
	 * Use this method instead of importing {@link org.classiclude.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link org.classiclude.gameserver.taskmanager.GameTimeTaskManager}.
	 */
