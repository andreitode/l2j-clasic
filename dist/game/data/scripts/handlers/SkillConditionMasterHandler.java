...
public class SkillConditionMasterHandler
{
	public static void main(String[] args)
	{
		...
		SkillConditionHandler.getInstance().registerHandler("ElementSeedsCondition", ElementSeedsCondition::new);
		SkillConditionHandler.getInstance().registerHandler("ElementSeedTotalCondition", ElementSeedTotalCondition::new);
		SkillConditionHandler.getInstance().registerHandler("ForceEffectCondition", ForceEffectCondition::new);
		SkillConditionHandler.getInstance().registerHandler("ConDistrust", ConDistrust::new);
	}
}
