...
import org.classiclude.gameserver.security.SecondaryPasswordAuth;
import org.classiclude.gameserver.util.FloodProtectors;

/**
 * Represents a client connected on GameServer.
 * @author KenM
 */
public class GameClient extends Client<org.classiclude.commons.network.Connection<GameClient>>
{
	...
	public GameClient(org.classiclude.commons.network.Connection<GameClient> connection)
	{
		super(connection);
