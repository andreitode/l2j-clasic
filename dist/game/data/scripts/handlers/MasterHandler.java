...
import org.classiclude.gameserver.handler.ActionHandler;
import org.classiclude.gameserver.handler.ActionShiftHandler;
...
import org.classiclude.gameserver.handler.AffectScopeHandler;
import org.classiclude.gameserver.handler.BypassHandler;
import org.classiclude.gameserver.handler.ChatHandler;
import org.classiclude.gameserver.handler.CommunityBoardHandler;
import org.classiclude.gameserver.handler.IHandler;
import org.classiclude.gameserver.handler.ItemHandler;
import org.classiclude.gameserver.handler.PlayerActionHandler;
import org.classiclude.gameserver.handler.PunishmentHandler;
import org.classiclude.gameserver.handler.TargetHandler;
import org.classiclude.gameserver.handler.UserCommandHandler;
import org.classiclude.gameserver.handler.VoicedCommandHandler;
...
import handlers.communityboard.VoteBoard;
...
import handlers.usercommandhandlers.PlayerSetLevel;
import handlers.usercommandhandlers.PlayerSetNobles;
import handlers.usercommandhandlers.SkinToggleCommand;
import handlers.usercommandhandlers.GiveAdena;
...
import handlers.voicedcommandhandlers.VoteSystem;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] HANDLERS =
	{
		...
		},
		{
			...
			Config.COMMUNITYBOARD_ENABLE_VOTE && Config.CUSTOM_VOTE_ENABLE ? VoteBoard.class : null,
		},
		{
			// Item Handlers
			Appearance.class,
		...
		},
		{
			...
			PlayerSetLevel.class,
			PlayerSetNobles.class,
			GiveAdena.class,
			SkinToggleCommand.class,
			Unstuck.class,
			InstanceZone.class,
			Loc.class,
			Mount.class,
		...
		},
		{
			...
			Config.CUSTOM_VOTE_ENABLE ? VoteSystem.class : null,
		},
		{
			// Target Handlers
			AdvanceBase.class,
